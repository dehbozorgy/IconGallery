...
class IconGallery extends StatefulWidget {
  ...
  const IconGallery({super.key, required this.Data, required this.galleryController});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Header(header: extensiones.toList(),galleryController: widget.galleryController),
          SizedBox(height: 10),
              ...
              builder: (context,value,_){
                ...
                return ElevatedButton(
                    onPressed: Active ? () {
                      ...
                      TypeImage typeImage = TypeImage.values.where((element) => element.name==header).firstOrNull ?? TypeImage.any;

                      Widget _widget = BaseWidget(typeImage: typeImage,Value: Img);
                  ...
                  style: ButtonStyle(
                      ...
                      backgroundColor: MaterialStateProperty.all( Active ? Colors.lightBlueAccent : Colors.grey.shade300),
