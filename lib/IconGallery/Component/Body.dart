...
import 'package:test1/IconGallery/Component/BaseWidget.dart';
import 'package:test1/IconGallery/Component/TypeImage.dart';
            ...
            builder: (context,value,_) {
              ...
              GridView.builder(
                  ...
                  itemBuilder: (context,index) {
                    bool Active = ActiveImg == lst!.elementAt(index).toString();
                    return
                      GestureDetector(
                        onTap: (){
                        ...
                        child: Container(
                          ...
                          child: Builder(builder: (context) {
                            ...
                            return FittedBox(child: BaseWidget(typeImage: typeImage,Value: lst!.elementAt(index)));
                          }),
